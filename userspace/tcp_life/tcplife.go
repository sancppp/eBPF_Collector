...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target amd64 -type Tcplife_event bpf ../../kern/tcplife.c -- -I../../kern/headers
...
func InitTcpLife(stopper <-chan struct{}, eventCh chan<- event.IEvent) {
	...
	// eBPF C program.
	rd, err := ringbuf.NewReader(objs.EventsTcplifeRb)
	if err != nil {
	...
	log.Println("Waiting for tcplife events..")

	// bpfEvent is generated by bpf2go.
	var bpfevent bpfTcplifeEvent
	for {
		record, err := rd.Read()
		if err != nil {
